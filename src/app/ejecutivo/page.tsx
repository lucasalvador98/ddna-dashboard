...
export default function ExecutiveDashboard() {
  ...
  const escolarizacion =
    findStatValue(dashboardData?.educacion ?? [], INDICATOR_NAMES.TASA_ASISTENCIA_EDUCATIVA) ??
    null;

  const matriculaTotal = findStatSum(
  ...
  const mortalidadInfantilInd = getLatestValue(dashboardData?.salud ?? [], INDICATOR_NAMES.TMI_CBA);
  ...
  const inversionSalud =
    sumInversionByKeyword(dashboardData?.inversion ?? [], 'salud') ||
      ...
      <div className="space-y-6 print:space-y-4">
        ...
        <div className="flex justify-end print:hidden">
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 text-sm bg-[#1a2556] text-white rounded-lg hover:bg-[#1a1a6e] transition-colors"
          >
        ...
        <div className="bg-red-50 border-2 border-red-200 rounded-xl p-4 flex items-start gap-3">
          ...
          <div>
            ...
            <ul className="mt-2 space-y-1 text-sm text-red-600 font-body">
              <li>
                • <strong>Violencia Familiar:</strong> {fmtNumber(violenciaFamiliar, '55,993')}{' '}
                casos registrados
              </li>
              <li>
                • <strong>Matemática Q1-Q2:</strong> +65% de estudiantes bajo nivel básico
              </li>
              <li>
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <KpiCard
              title="Salud"
              value={inversionSalud > 0 ? fmtCurrency(inversionSalud, '$171,200 M') : '$171,200 M'}
              subtitle={
        ...
        <section className="bg-gradient-to-r from-[#1a2556] to-[#1a1a6e] rounded-xl p-6 text-white">
        ...
        <section className="pt-6 border-t border-gray-200 text-center">
          <p className="text-xs text-gray-400 font-body">
            Fuentes: INDEC, Ministerio de Educación, DEIS, Poder Judicial Córdoba, Ministerio de
            Finanzas
            <br />
