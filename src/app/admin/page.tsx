...
function StatRow({
  ...
  return (
    <div className="flex items-center gap-3 py-2.5">
      ...
      <span className="text-sm font-display text-navy tabular-nums">{value}</span>
    </div>
  );
}
...
function KpiCard({
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-5">
      ...
      <p className="font-display text-2xl text-navy tabular-nums">{value}</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card icon={Zap} title="Acciones rápidas">
          <div className="space-y-3">
            ...
            <a
              href="/monitoreo"
              className="w-full flex items-center gap-3 px-4 py-3 bg-gray-50 hover:bg-gray-100 rounded-xl text-sm text-navy font-medium transition-colors"
            >
