  ...
  return (
    <div className="space-y-3">
      ...
      <button
        onClick={refresh}
        disabled={loading}
        className="w-full flex items-center gap-3 px-4 py-3 bg-gray-50 hover:bg-gray-100 rounded-xl text-sm text-navy font-medium transition-colors text-left disabled:opacity-60"
      >
