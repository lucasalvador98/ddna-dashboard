    ...
    <>
      ...
      >
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-gray-200">
          <h2 className="font-accent text-base text-navy">Detalle del archivo</h2>
          <button
            onClick={onClose}
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              ...
              {!editing && (
                <button
                  ...
                  className="text-[10px] text-blue hover:text-navy flex items-center gap-0.5"
                  type="button"
                >
            ...
            {editing ? (
              <textarea
                ...
                className="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-navy focus:border-transparent outline-none resize-none"
              />
            ) : (
              <p
