    ...
    <>
      ...
      >
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-gray-200">
          <h2 className="font-accent text-base text-[#334155]">Detalle del archivo</h2>
          <button
            onClick={onClose}
        ...
        <div className="flex-1 overflow-y-auto px-5 py-5 space-y-5">
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-sm font-semibold text-[#334155] break-all">
                {file.nombre_archivo}
              </p>
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              ...
              {!editing && (
                <button
                  ...
                  className="text-[10px] text-[#3777FF] hover:text-[#334155] flex items-center gap-0.5"
                  type="button"
                >
            ...
            {editing ? (
              <textarea
                ...
                className="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-[#334155] focus:border-transparent outline-none resize-none"
              />
            ) : (
              <p
          ...
          {editing ? (
            <>
              ...
              <button
                ...
                className="flex items-center gap-1.5 px-4 py-1.5 bg-[#334155] text-white rounded-lg text-sm font-medium hover:bg-[#0F172A] disabled:opacity-50"
                type="button"
              >
            ...
            <>
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-1.5 bg-[#334155] text-white rounded-lg text-sm font-medium hover:bg-[#0F172A] disabled:opacity-50"
                  type="button"
                >
