...
export function RepoUploadZone({ onUploaded }: Props) {
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-2xl p-5">
      <h3 className="font-accent text-base text-navy mb-3 flex items-center gap-2">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div>
              ...
              <select
                ...
                className="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-navy focus:border-transparent outline-none bg-white"
              >
                {CATEGORIES.map(c => (
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-navy focus:border-transparent outline-none"
              />
            </div>
          </div>
          <div>
