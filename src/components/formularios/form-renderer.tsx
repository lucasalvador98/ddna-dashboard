...
// that become hidden. UI strings in Spanish; comments/ids in English.
...
export function FormRenderer({
  ...
  function handleChange(fieldId: string, value: unknown) {
    setAnswers((prev) => {
      ...
      // Clear answers of fields that the new evaluation hides.
  ...
  async function handleSubmit() {
    ...
    for (const field of definicion.fields) {
