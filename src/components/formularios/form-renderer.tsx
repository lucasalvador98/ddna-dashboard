    ...
    >
      ...
      {!preview && onSubmit && (
        <button
          ...
          disabled={submitting}
          className={clsx(
            'inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-lg text-sm font-medium text-white bg-navy hover:bg-[#475569] transition-colors disabled:opacity-60'
          )}
        >
